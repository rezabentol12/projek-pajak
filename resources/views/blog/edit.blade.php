...
<div class="container">
  ...
  <select class="form-control" name="jenis" value="{{$blog->jenis}}" >
  ...
  <table>
    <tr>Kategori :</tr>
    <td>
      <select name="kategori" value="{{$blog->kategori}}">
        ...
        <table class="mt-lg-4">
          <tr>
            <td>Nama </td>
            <td>:</td>
            <td><input type="text" name="nama" id="" value="{{$blog->nama}}" ></td>
          </tr>
          <tr>
            <td>Gelar Depan</td>
            <td>:</td>
            <td><input type="text" name="gelardepan" id="" value="{{$blog->gelardepan}}" ></td>
          </tr>
          <tr>
            <td>Gelar Belakang</td>
            <td>:</td>
            <td><input type="text" name="gelarbelakang" id="" value="{{$blog->gelarbelakang}}" ></td>
          </tr>
          <tr>
            <td>Tempat Lahir</td>
            <td>:</td>
            <td><input type="text" name="tempatlahir" id="" value="{{$blog->tempatlahir}}" ></td>
          </tr>
          <tr>
            <td>Status Perkawinan</td>
            <td>:</td>
            <td><input type="text" name="status" id="" value="{{$blog->status}}" ></td>
          </tr>
          <tr>
            <td>Kebangsaan </td>
            <td>:</td>
            <td><input type="text" name="kebangsaan" id="" value="{{$blog->kebangsaan}}" ></td>
          </tr>
          <tr>
            <td>NO Telp</td>
            <td>:</td>
            <td><input type="text" name="notelp" id="" value="{{$blog->notelp}}" ></td>
          </tr>
          <tr>
            <td>Email</td>
            <td>:</td>
            <td><input type="text" name="email" id="" value="{{$blog->email}}" ></td>
          </tr>
          <tr>
            <td>masukan gambar KTP</td>
            <td>:</td>
            <td><input type="file" name="gambar" id="" value="{{$blog->gambar}}" ></td>
          </tr>
        </table>
